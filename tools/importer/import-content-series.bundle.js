var CustomImportScript = (() => {
  ...
  // tools/importer/import-content-series.js
  var import_content_series_exports = {};
  __export(import_content_series_exports, {
    default: () => import_content_series_default
  });
  ...
  function parse3(element, { document }) {
    ...
    columns.forEach((col) => {
      ...
      const thumbnail = col.querySelector('img[class*="thumbnail"]') || col.querySelector(".cmp-image img") || col.querySelector("img");
      const titleEl = col.querySelector(".body-unica-20-reg") || col.querySelector(".cmp-title h3, .cmp-title h2, h3, h2");
      const titleText = (_a = titleEl == null ? void 0 : titleEl.textContent) == null ? void 0 : _a.trim();
      const descEl = col.querySelector(".body-unica-18-reg") || col.querySelector(".cmp-text p, .cmp-text");
      ...
      if (videoUrl) {
        ...
        watchText = (_c = watchBtn == null ? void 0 : watchBtn.textContent) == null ? void 0 : _c.trim();
      }
      const textFrag = document.createDocumentFragment();
      textFrag.appendChild(document.createComment(" field:text "));
      if (titleText) {
  ...
  var import_content_series_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_content_series_exports);
})();
